...
# A1
        (self.feed('data')
             .conv(3, 3, 64, 1, 1, biased=True, relu=False, name='A1_conv_1')#[1,380,380,64]
             .conv(3, 3, 64, 1, 1, biased=True, relu=False, name='A1_conv_2')#[1,380,380,64]
             .max_pool(2, 2, 2, 2, name='A1_pool'))#[1,190,190,64]

# A2
        (self.feed('A1_pool')
             .conv(3, 3, 128, 1, 1, biased=True, relu=False, name='A2_conv_1')
             .conv(3, 3, 128, 1, 1, biased=True, relu=False, name='A2_conv_2')
             .max_pool(2, 2, 2, 2, name='A2_pool'))

# A3
        (self.feed('A2_pool')
             .conv(3, 3, 256, 1, 1, biased=True, relu=False, name='A3_conv_1')
             .conv(3, 3, 256, 1, 1, biased=True, relu=False, name='A3_conv_2')
             .conv(3, 3, 256, 1, 1, biased=True, relu=False, name='A3_conv_3')
             .max_pool(2, 2, 2, 2, name='A3_pool'))

# A4
        (self.feed('A3_pool')
             .conv(3, 3, 512, 1, 1, biased=True, relu=False, name='A4_conv_1')
             .conv(3, 3, 512, 1, 1, biased=True, relu=False, name='A4_conv_2')
             .conv(3, 3, 512, 1, 1, biased=True, relu=False, name='A4_conv_3')
             .max_pool(2, 2, 2, 2, name='A4_pool'))

# A5
        (self.feed('A4_pool')
             .conv(1, 1, 512, 1, 1, biased=True, relu=False, name='A5_conv_1')
             .conv(1, 1, 512, 1, 1, biased=True, relu=False, name='A5_conv_2')
             .conv(1, 1, 512, 1, 1, biased=True, relu=False, name='A5_conv_3')
             .max_pool(2, 2, 2, 2, name='A5_pool'))

# A6
        (self.feed('A5_pool')
             .conv(7, 7, 4096, 1, 1, biased=True, relu=False, name='A6_conv'))

# A7
        (self.feed('A6_conv')
             .conv(1, 1, 4096, 1, 1, biased=True, relu=False, name='A7_conv'))
